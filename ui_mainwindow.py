...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.text_pagesNum = QTextEdit(self.widget_splitter)
        self.text_pagesNum.setObjectName(u"text_pagesNum")
        self.text_pagesNum.setGeometry(QRect(10, 50, 51, 31))
        self.text_pagesNum.setReadOnly(True)
